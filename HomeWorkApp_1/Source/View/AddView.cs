...
{
    public class AddView : TaskView
    {
        public override string OperationPrefix => "Add";

        private ArrayHandler _arrayHandler;

        public AddView(StackPanel stackPanel, ArrayHandler arrayHandler) : base(stackPanel)
        {
        ...
        protected override void OnInputChange(object sender, TextChangedEventArgs e)
        {
            ...
            _arrayHandler.Add(firstArray).ToList().ForEach(x => result += $"{x}, ");
